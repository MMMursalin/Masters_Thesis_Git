...
Species2Monitor = ['SmallP', 'SmallN', 'SmallO', 'MedP', 'MedN', 'MedO', 'LargeN','LargeP']
...
kappa = 1/0.001 #nm-1, inverse Debye length, used when kappa isnt calculated
